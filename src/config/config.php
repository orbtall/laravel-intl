...
return [
    ...
    // You can use driver = file to use config file or use driver = database to fetch locales from database.
    'driver' => 'database',
    ...
    'supportedLocales' => [
        'us-en' => ['name' => 'United States', 'name_native' => 'United States', 'script' => 'Latn', 'language' => 'English', 'regional' => 'en_US'],
    ],
