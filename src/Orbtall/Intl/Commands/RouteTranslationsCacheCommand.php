...
namespace Orbtall\Intl\Commands;

use Illuminate\Foundation\Console\RouteCacheCommand;
use Orbtall\Intl\Intl;
use Orbtall\Intl\Traits\TranslatedRouteCommandContext;
    ...
    protected function buildRouteCacheFile(RouteCollection $routes)
    {
        ...
        return str_replace(
            ...
            [
                ...
                $this->getIntl()->getSerializedTranslatedRoutes(),
            ],
            $stub
        );
    }
