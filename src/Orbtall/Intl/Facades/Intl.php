...
namespace Orbtall\Intl\Facades;
 ...
 * @method static string getCurrentLocaleLanguage()
 * @method static string getCurrentLocaleDirection()
 * @method static string getCurrentLocaleScript()
 * @method static string getCurrentLocaleLanguageReading()
 ...
 *
 * @see \Orbtall\Intl\Intl
 */
class Intl extends Facade
{
    /**
