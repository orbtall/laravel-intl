...
use Orbtall\Intl\Exceptions\SupportedLocalesNotDefined;
use Orbtall\Intl\Exceptions\UnsupportedLocaleException;

use Orbtall\Intl\Models\Locale;
...
class Intl
{
    ...
    public function setLocale($locale = null)
    {
        ...
        $suffix = $this->configRepository->get('intl.utf8suffix');
        if ($regional) {
    ...
    public function getLocalesMapping()
    {
        if (empty($this->localesMapping)) {
            $this->localesMapping = $this->configRepository->get('intl.localesMapping');
        }
    ...
    public function getLocalesOrder()
    {
        ...
        $order = $this->configRepository->get('intl.localesOrder');
    ...
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['name_native'];
    }
     ...
     */
    public function getCurrentLocaleLanguage()
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['language'];
    }
     ...
     */
    public function getCurrentLocaleLanguageReading()
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['language'];
    }
    ...
    /**
     * Returns current region code.
     *
     * @return string current region code
     */
    public function getCurrentRegionCode()
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['region_code'];
    }
    ...
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['region_name'];
    }
    ...
    {
        return $this->configRepository->get('intl.useAcceptLanguageHeader');
    }
    ...
    {
        return $this->configRepository->get('intl.hideDefaultLocaleInURL');
    }
