...
Once this route group is added to the routes file, a user can access all locales added into `supportedLocales` (`us-en` by default).
...
To implement `\Orbtall\LaravelLocalization\Interfaces\LocalizedUrlRoutable`,
